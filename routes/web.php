...
Route::group(['middleware' => 'is_admin','prefix' => 'admin', 'as' => 'admin.'], function() {
    ...
    Route::resource('bookservice', \App\Http\Controllers\Admin\BookserviceController::class);
...
Route::resource('securetech', \App\Http\Controllers\SecuretechController::class);

//cctv installation offer
Route::get('offerservice', [App\Http\Controllers\Admin\ServiceController::class,'offerservice']);

//forms
Route::get('bookingform', [BookingFormController::class, 'index']);
Route::post('booking-form', [BookingFormController::class, 'store']);

Route::get('surveyform', [SurveyFormController::class, 'index']);
Route::post('survey-form', [SurveyFormController::class, 'store']);